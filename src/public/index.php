        ...
        <div class="row justify-content-center">
            <div class="col-lg-8 col-xl-7">
                ...
                <form id="contactForm" data-sb-form-api-token="API_TOKEN" method="POST"
                    ...
                    <!-- Phone number input-->
                    <div class="form-floating mb-3">
                        <input class="form-control" name="phone" id="phone" type="tel" placeholder="+7(700)111-22-33"
                               data-sb-validations="required" required/>
                    ...
                    <input class="form-control" id="test" name="test" type="hidden" value="test"/>
                    ...
                    <!-- Submit Button-->
                    <button class="btn btn-primary btn-xl <?php echo ($_SESSION['order'] ?? '') ? 'disabled' : '' ?>"
                            id="submitButton" type="submit" onclick="">Send
                    </button>
                </form>
            </div>
        </div>
