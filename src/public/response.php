...
<div class="masthead bg-primary text-white text-center">
    <div class="container d-flex align-items-center flex-column">
        <?php if ($_SESSION['order'] === true) { ?>
            <p class="masthead-subheading font-weight-light mb-0">Спасибо, ваш заказ принят!</p>
        <?php } else { ?>
            <p class="masthead-subheading font-weight-light mb-0 text-danger">Ошибка, ваш заказ не принят!</p>
        <?php } ?>
    </div>
</div>
<!-- Footer-->
